...
export default {
  data() {
    return {
      ...
      steps: [
        {
          title: 'Thanks for Joining GBstreams',
        ...
        {
          title: 'Eh, So, What is GBstreams Exactly',
    ...
    <section class="">
      ...
      <div class="">
        ...
        <div v-if="currentStep === 3">
          ...
          <p class="text-coolGray-500 ">
            {{ steps[currentStep - 1].subInstructions }}
          </p>
        </div>
        <div class="">
          <ul
          ...
          >
            <li
              v-for="bullet in steps[currentStep - 1].bulletPoints"
        ...
        <div class="flex justify-center">
          <a
            class="py-2 px-4 my-4 text-base text-black font-medium text-center leading-6 bg-yellow focus:ring-2 focus:ring-bluer focus:ring-opacity-50 rounded-md shadow-sm"
