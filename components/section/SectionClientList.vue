  ...
  >
    <div class="flex flex-row flex-wrap py-2 ">
      <div
        ...
        :class="{ 'text-primary': recommendedFilter === 'recommended' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': recommendedFilter === 'false' }"
    ...
    <div class="flex flex-row flex-wrap py-2">
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': deviceTypeFilter === 'all' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': deviceTypeFilter === 'Desktop' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': deviceTypeFilter === 'Mobile' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': deviceTypeFilter === 'TV' }"
    ...
    <div class="flex flex-row flex-wrap py-2">
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'all' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'Android' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'Android TV' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'Desktop' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'Fire TV' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'IOS' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'Kodi' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'Roku' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'tvOS' }"
      ...
      <div
        class="px-4 cursor-pointer"
        :class="{ 'text-primary': platformFilter === 'webos' }"
    ...
    <UCard class="p-4 mb-4 text-gray-200">
      <div class="flex justify-between items-center">
        <div class="flex items-center">
          <h2 class="text-xl font-bold mr-2">
            {{ client.name }}
          </h2>
          <UBadge
            :label="client.tag"
            :color="getTagColor(client.tag)"
            variant="solid"
      ...
      <div class="flex justify-between items-center">
        <UButton
          color="cyan"
          variant="outline"
          :label="client.projectText"
          :to="client.projectLink"
        ...
        <div class="flex space-x-1 items-center">
          <UButton
            ...
            color="gray"
            variant="solid"
            :label="client.downloadTextThree"
            :to="client.downloadLinkThree"
            :ui="{ rounded: 'rounded-full' }"
          />
          <UButton
            ...
            color="gray"
            variant="solid"
            :label="client.downloadTextTwo"
            :to="client.downloadLinkTwo"
            :ui="{ rounded: 'rounded-full' }"
          />
          <UButton
            color="gray"
            variant="solid"
            :label="client.downloadText"
            :to="client.downloadLink"
            :ui="{ rounded: 'rounded-full' }"
          />
          <UButton
            color="gray"
            variant="solid"
            :label="client.installText"
            :to="client.installLink"
            :ui="{ rounded: 'rounded-full' }"
          />
        </div>
      </div>
